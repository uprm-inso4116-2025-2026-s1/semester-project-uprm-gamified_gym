...
==== 1.2.1 Current Situation
  ...
  The fitness application market is saturated with products that solely focus on data logging (sets, repetitions, and 
calories burned). While other apps like MyFitnessPal, Strong, and Fitbod offer reliable tracking tools, studies, and user
reviews often note that they fail to get long-term engagement. In the study from the "Journal of Medical Internet Research 
(2021)" indicates that user retention in fitness apps drops by over 70% withing the first month due to repetetive data logging
and lack of motivation. Similarly, Peng et al. (2016) found that users often perceive health and fitness apps as “tools that 
just log data,” offering awareness but little actionable feedback or motivation to continue.

  As a result, users perceive these applications as digital notebooks that record progress but offer little to no motivation to follow
on their fitness routine. The absence of interaction reduces the sense of accomplishment and makes workouts feel boring. 
Additionally, without visual feedback or balance tracking, users will favor specific muscle groups while neglecting others,
which can lead to uneven development and increased injury risk.
