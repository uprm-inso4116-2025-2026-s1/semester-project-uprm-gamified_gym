...
“The stitch returned almost immediately…”
...
=== Concept: Equipment Transition

Definition:
Switching from one exercise or machine to another.
...
“I switched to lighter lateral raises.”
