  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView
        ...
        refreshControl={
          <RefreshControl refreshing={refreshing} onRefresh={onRefresh} tintColor="#2C82FF" />
        }
      >
                ...
                >
                  <View style={styles.workoutHeaderLeft}>
                    <View style={styles.dateContainer}>
                      <Text style={styles.dateText}>{formatDate(workout.date_completed)}</Text>
                      <Text style={styles.timeText}>{formatTime(workout.date_completed)}</Text>
                    </View>
                    <View style={styles.workoutInfo}>
                      <Text style={styles.workoutName}>{workout.workout_name}</Text>
                      <Text style={styles.workoutMeta}>
                        {workout.exercises.length} exercise{workout.exercises.length !== 1 ? 's' : ''} · {completedSets}/{totalSets} sets
                      </Text>
                    </View>
                  </View>
                  <Ionicons
                ...
                {isExpanded && (
                  <View style={styles.exercisesList}>
                    {workout.exercises.map((exercise, index) => (
                      <View key={`${exercise.exerciseId}-${index}`} style={styles.exerciseItem}>
